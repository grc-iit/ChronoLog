...
inline const char*getRPCImplString(ChronoLogRPCImplementation impl)
{
    switch(impl)
    {
        case CHRONOLOG_THALLIUM_SOCKETS:
            return "CHRONOLOG_THALLIUM_SOCKETS";
        case CHRONOLOG_THALLIUM_TCP:
            return "CHRONOLOG_THALLIUM_TCP";
        case CHRONOLOG_THALLIUM_ROCE:
            return "CHRONOLOG_THALLIUM_ROCE";
        default:
            return "UNKNOWN";
    }
}
...
inline const char*getServiceRoleString(ChronoLogServiceRole role)
{
    switch(role)
    {
        case CHRONOLOG_UNKNOWN:
            return "CHRONOLOG_UNKNOWN";
        case CHRONOLOG_VISOR:
            return "CHRONOLOG_VISOR";
        case CHRONOLOG_CLIENT:
            return "CHRONOLOG_CLIENT";
        case CHRONOLOG_KEEPER:
            return "CHRONOLOG_KEEPER";
        default:
            return "CHRONOLOG_UNKNOWN";
    }
}
