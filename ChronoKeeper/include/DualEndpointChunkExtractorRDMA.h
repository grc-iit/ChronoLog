...
public:
    DualEndpointChunkExtractorRDMA( tl::engine & tl_engine, ServiceId const & receiver_player= ServiceId(), ServiceId const& receiver_grapher = ServiceId());
    ...
    { return (nullptr != rdma_sender_for_grapher) && (nullptr != rdma_sender_for_player); }
