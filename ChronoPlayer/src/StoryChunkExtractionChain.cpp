...
//////////////////////////////
/*template <>
void chronolog::StoryChunkExtractionChain::startExtractionThreads(int stream_count)
{
...
template <>
v{oid chronolog::StoryChunkExtractionChain::shutdownExtractionThreads()
{
  //  std::lock_guard lock(extractorMutex);
...
//////////////////////
template <typename T>
chronolog::StoryChunkExtractionChain::~StoryChunkExtractionChain()
{
...
template <typename T>
vo5id chronolog::StoryChunkExtractionChain::drainExtractionQueue()
{
