                                                ...
                                                , chl::KeeperRegistry*keeperRegistry)
{
    ...
    try
    {
        ...
        std::string CLIENT_PORTAL_SERVICE_NA_STRING =
                confManager.VISOR_CONF.VISOR_CLIENT_PORTAL_SERVICE_CONF.PROTO_CONF + "://" +
                confManager.VISOR_CONF.VISOR_CLIENT_PORTAL_SERVICE_CONF.IP + ":" +
                std::to_string(confManager.VISOR_CONF.VISOR_CLIENT_PORTAL_SERVICE_CONF.BASE_PORT);

        uint16_t provider_id = confManager.VISOR_CONF.VISOR_CLIENT_PORTAL_SERVICE_CONF.SERVICE_PROVIDER_ID;
