                                                  ...
                                                  , int &flags)
{
    ...
    { return chronolog::to_int(chronolog::ClientErrorCode::NotAuthorized); }
                                           ...
                                           , const std::map <std::string, std::string> &attrs, int &flags)
{
    ...
    if(!story_action_is_authorized(client_id, chronicle_name, story_name))
    { return chronolog::AcquireStoryResponseMsg(chronolog::to_int(chronolog::ClientErrorCode::NotAuthorized), story_id, recording_keepers); }

    int ret = chronolog::to_int(chronolog::ClientErrorCode::Unknown);
