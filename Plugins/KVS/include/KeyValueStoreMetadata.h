...
public :
    KeyValueStoreMetadata(std::string &sname, int n, std::vector <std::string> &types, std::vector <std::string> &names
                          , std::vector <int> &lens, int len)
    {
        name = sname;
        numattributes = n;
    ...
    void get_attribute_features(std::string &sname, std::vector <std::string> &types, std::vector <std::string> &names
                                , std::vector <int> &lens)
    {
        sname.assign(name);
