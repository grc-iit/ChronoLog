...
void
create_ycsb_input(std::string &, int, int, std::vector <uint64_t> &, std::vector <std::string> &, std::vector <int> &);

void create_timeseries_testinput(std::string &, int, int, std::vector <uint64_t> &, std::vector <float> &
                                 , std::vector <int> &);

void create_dataworld_testinput(std::string &, int, int, std::vector <uint64_t> &, std::vector <uint64_t> &
                                , std::vector <int> &);
