...
public:
    ...
    void remote_addrs(std::vector <std::string> &shmaddrs_r, std::vector <std::string> &ipaddrs_r
                      , std::vector <std::string> &serveraddrs_r)
    {
    ...
    void bind_functions()
    {
        std::function <void(const tl::request &, struct query_req &r)> PutRequestFunc(
                std::bind(&distributed_queues::ThalliumLocalPutRequest, this, std::placeholders::_1
                          , std::placeholders::_2));

        std::function <void(const tl::request &, struct query_resp &r)> PutResponseFunc(
                std::bind(&distributed_queues::ThalliumLocalPutResponse, this, std::placeholders::_1
                          , std::placeholders::_2));

        std::function <void(const tl::request &, std::vector <std::string> &s)> PutRemoteAddresses(
                std::bind(&distributed_queues::ThalliumRemoteAddresses, this, std::placeholders::_1
                          , std::placeholders::_2));
