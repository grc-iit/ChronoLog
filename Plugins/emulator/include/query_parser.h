...
public:
    ...
    void add_event_header(std::string s, int nattrs, std::vector <std::string> &attr_names, std::vector <int> &vsizes
                          , std::vector <bool> &sign, std::vector <bool> &end)
    {
    ...
    bool select_by_attr(std::string &, std::string &, std::vector <struct event> &, event_metadata &, T &
                        , std::vector <view> &);

    bool sort_events_by_attr(std::string &s, std::vector <struct event> &, std::string &a, event_metadata &
                             , std::vector <view> &);
    ...
    template <typename T, class EqualFcn=std::equal_to <T>>
    bool select_unique_by_attr(std::string &, std::string &, std::vector <struct event> &, event_metadata &, T &
                               , std::vector <view> &);
};
