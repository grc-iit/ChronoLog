...
public:
    ...
    KeeperIdCard(KeeperIdCard const &other): keeper_group_id(other.getGroupId()), ip_addr(other.getIPaddr()), port(
            other.getPort()), tl_provider_id(other.getProviderId())
    {}
