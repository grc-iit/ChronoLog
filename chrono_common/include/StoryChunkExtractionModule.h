...
public:
    ...
    void drainExtractionQueue()
    {
        ...
        // and until the extractionQueue is drained in when state == SHUTTTING_DOWN
         ...
         LOG_DEBUG("[StoryChunkExtractionModule] DrainExtractionQueue called by stream rank={}, tl::thread_id={} extractionQueue size {} ", es.get_rank()
    ...
    void shutdownExtraction()
    {
        ...
        LOG_DEBUG("[StoryChunkExtractionModule] Initiating shutdown: extractionQueue size {}", chunkExtractionQueue.size());
...
//////////////////////
    ...
    {
        LOG_DEBUG("[StoryChunkExtractionModule] Destructor called. Initiating shutdown: extractionQueue size {}", chunkExtractionQueue.size());
