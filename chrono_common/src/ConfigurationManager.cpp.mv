...
{
    if(extraction_module_conf != nullptr) { delete extraction_module_conf; }
}
//////////////
...
std::string & chl::KeeperConfiguration::to_string( std::string & a_string) const
{
    a_string += "[CHRONO_KEEPER_CONFIGURATION: RECORDING_GROUP: " + std::to_string(RECORDING_GROUP) +
            ...
            ", " + (extraction_module_conf != nullptr ? extraction_module_conf->to_string(a_string) : std::string("ExtractionModuleConf { }")) + 
            "]";
