...
<<<<<<< HEAD
    ...
    echo ""
    echo "  2) Installs ChronoLog to the specified installation directory:"
    ...
    echo "     pulling the binaries from the specified installation directory."
    ...
    echo "     using the specified installation directory."
