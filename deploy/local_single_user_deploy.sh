...
usage() {
    ...
    echo ""
    echo "  2) Installs ChronoLog to the specified working directory:"
    echo "     $0 --install --work-dir /path/to/workdir"
    echo ""
    echo "  3) Starts a ChronoLog deployment using the default configuration and paths,"
    echo "     pulling the binaries from the specified working directory."
