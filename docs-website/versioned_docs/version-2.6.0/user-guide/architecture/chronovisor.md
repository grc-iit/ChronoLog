...
<svg viewBox="0 0 720 640" width="100%" xmlns="http://www.w3.org/2000/svg" fontFamily="system-ui, sans-serif">
  ...
  <text x="100" y="147" textAnchor="middle" fill="#9ca3b0" fontSize="6" fontStyle="italic">(stub in v2.6.0)</text>
...
| **Client Authentication Module**       | Defines the authentication and authorization interface for client access control. In v2.6.0 all checks are implemented as stubs that grant access unconditionally; full role-based authentication is planned for a future release.                                                                                                                                                                                                                                                                                                           |
