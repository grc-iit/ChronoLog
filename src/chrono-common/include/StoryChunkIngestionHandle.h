...
public:
    StoryChunkIngestionHandle(std::mutex& a_mutex, StoryChunkDeque* active, StoryChunkDeque* passive)
    ...
    StoryChunkDeque& getActiveDeque() const { return *activeDeque; }

    StoryChunkDeque& getPassiveDeque() const { return *passiveDeque; }
