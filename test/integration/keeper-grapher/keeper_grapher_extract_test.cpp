...
int main(int argc, char** argv)
{
    ...
    {
        std::cout << "Integration_KeeperGrapher_StoryChunkExtract: no config path provided; skipping (run manually "
                     "with --conf <path>)."
                  << std::endl;
        return 0;
    }
    ...
    std::string KEEPER_GRAPHER_PROTOCOL = KEEPER_CONF.KEEPER_GRAPHER_DRAIN_SERVICE_CONF.PROTO_CONF;
