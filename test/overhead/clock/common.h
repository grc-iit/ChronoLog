...
my_clock::time_point * collect_w_std_high_res_clock_alap(int test_reps, int sleep_time = 0) {
    my_clock::time_point * clock_list = (my_clock::time_point *)
            malloc((test_reps + 1) * sizeof(my_clock::time_point));
...
void printStatLine(std::ofstream &fout, std::vector<T> &duration_list) {
    ...
    fout << duration_list.at(0) << "\t"
         << duration_list.at(len * 0.001) << "\t"
         << duration_list.at(len * 0.01) << "\t"
         << duration_list.at(len * 0.5) << "\t"
         << duration_list.at(len * 0.99) << "\t"
         << duration_list.at(len * 0.999) << "\t"
