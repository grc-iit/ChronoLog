...
int main(int argc, char*argv[])
{
     ...
     */
    {
        ...
        std::cout << "[HighResClockTest] Test with __builtin_ia32_rdtsc() calls: " << std::endl;
        std::cout << "[HighResClockTest] CPU_GHZ_INV: " << CPU_GHZ_INV << std::endl;
        printVectorStats(duration_list);
        std::cout << "[HighResClockTest] Resolution: N/A" << std::endl;
     ...
     */
    {
        ...
        std::vector <double> duration_list;
        convert_ull_to_double_vec(clock_list, test_reps, duration_list);
        std::cout << "[HighResClockTest] Test with __builtin_ia32_rdtscp() calls on processor: " << proc_id << std::endl;
        std::cout << "[HighResClockTest] CPU_GHZ_INV: " << CPU_GHZ_INV << std::endl;
        printVectorStats(duration_list);
     ...
     */
    {
        ...
        struct timespec res;
        std::cout << "[HighResClockTest] Test with clock_gettime(CLOCK_MONOTONIC) calls: " << std::endl;
        printVectorStats(duration_list);
        // writeVectorStatsToFile(duration_list);
        sort(duration_list.begin(), duration_list.end());
...

    {
        ...
        convert_timespec_to_ull_vec(clock_list, test_reps, duration_list);
        struct timespec res;
        std::cout << "[HighResClockTest] Test with clock_gettime(CLOCK_MONOTONIC_RAW) calls: " << std::endl;
        printVectorStats(duration_list);
        sort(duration_list.begin(), duration_list.end());
     ...
     */
    {
        ...
        std::cout << "[HighResClockTest] Test with std::chrono::high_resolution_clock::now() calls (count as late as possible): " << std::endl;
        printVectorStats(duration_list);
        sort(duration_list.begin(), duration_list.end());
        fout << "C++11(alap)\t";
        printStatLine(fout, duration_list);
        std::cout << "[HighResClockTest] Resolution (ns): " << (double)std::chrono::high_resolution_clock::period::num /
...

    {
        ...
        std::vector <double> duration_list;
        convert_ull_to_double_vec(clock_list, test_reps, duration_list);
        std::cout << "[HighResClockTest] Test with std::chrono::high_resolution_clock::now() calls (count immediately): " << std::endl;
        printVectorStats(duration_list);
        sort(duration_list.begin(), duration_list.end());
        fout << "C++11(imme)\t";
        printStatLine(fout, duration_list);
