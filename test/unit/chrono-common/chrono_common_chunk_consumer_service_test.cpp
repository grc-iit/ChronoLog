...
int main()
{
    ...
    try
    {
        ...
        chunkConsumerService =
                chronolog::StoryChunkConsumerService::CreateChunkConsumerService(*localEngine,
    ...
    LOG_INFO("[ChunkConsumerServiceTest] Shutting down StoryChunkConsumerService at {}",
